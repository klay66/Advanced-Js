...
// myReq.open("GET", "https://api.github.com/users/klay66/repos")
// myReq.send()
// console.log(myReq);
...
// function make(e) {
//   e.target.style.color = "#123098"
// }

// let p = document.querySelector(".text")
// p.addEventListener("click", make)
...
//   })
// }
// getData("https://api.github.com/users/klay66/repos")
//   .then((res) => {
//     res.length = 10
//     return res
//   }).then((res) => {
...
// fetch("https://api.github.com/users/klay66/repos")
//   .then((res) => {
//     console.log(res);
//     let myData = res.json()
//     console.log(myData)
...
async function fetchData() {
  ...
  try {
    let myData = await fetch("https://api.github.com/users/klay66/repos")
